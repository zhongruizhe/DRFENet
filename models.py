...
class BTBUNet(nn.Module):
    def __init__(self, channels, num_of_layers=15):
        super(BTBUNet, self).__init__()
        kernel_size = 3
        padding = 1
        features = 64
        groups = 1
...
'''
class BTBUNetwithoutDEB(nn.Module):
    def __init__(self, channels, num_of_layers=15):
        super(BTBUNetwithoutDEB, self).__init__()
        kernel_size = 3
        padding = 1
        features = 64
        groups = 1
...
class BTBUNetwithoutRDB(nn.Module):
    def __init__(self, channels, num_of_layers=15):
        super(BTBUNetwithoutRDB, self).__init__()
        kernel_size = 3
        padding = 1
        features = 64
        groups = 1
...
class BTBUNetwithoutconcat(nn.Module):
    def __init__(self, channels, num_of_layers=15):
        super(BTBUNetwithoutconcat, self).__init__()
        kernel_size = 3
        padding = 1
        features = 64
        groups = 1
